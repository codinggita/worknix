...
app.put('/user_profiles/:employee_id', async (req, res) => {
    try {
        ...
        console.log('Updating profile with employee_id:', employee_id);
        console.log('Updated profile data:', updatedProfile);
...
// PATCH: Partially update a user profile (including profile photo)
app.patch('/user_profiles/:employee_id', async (req, res) => {
    try {
        const employee_id = req.params.employee_id;
        const updates = req.body;
...
app.delete('/user_profiles/:employee_id', async (req, res) => {
    try {
        const employee_id = req.params.employee_id;
        console.log('Deleting profile with employee_id:', employee_id);
