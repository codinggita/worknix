...
//     try {
//       // Replace the local URL with the Render URL
//       const res = await axios.post("https://login-signup-worknix.onrender.com/login", formData);
...
const Lefts = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Update the login API URL to use the new Render URL
      const res = await axios.post("https://worknix-lgin-and-signup.onrender.com/login", formData);
