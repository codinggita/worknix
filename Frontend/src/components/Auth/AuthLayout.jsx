...
// export function AuthLayout({ children, title, toggleAuth, isLogin }) {
//   const fadeIn = {
//     initial: { opacity: 0, y: 20 },
//     animate: { opacity: 1, y: 0 },
//     transition: { duration: 0.5 }
...
//           <motion.div className="flex justify-center gap-4 mb-6" {...fadeIn} transition={{ delay: 0.2 }}>
//             <button className="p-3 rounded-full border hover:bg-gray-50 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
//               <img src="https://upload.wikimedia.org/wikipedia/commons/5/53/Google_%22G%22_Logo.svg" alt="Google" className="w-6 h-6" />
//             </button>
//             <button className="p-3 rounded-full border hover:bg-gray-50 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1">
...
//           {/* Divider */}
//           <motion.div className="relative mb-6" {...fadeIn} transition={{ delay: 0.3 }}>
//             <div className="absolute inset-0 flex items-center">
//               <div className="w-full border-t border-gray-300"></div>
//             </div>
//             <div className="relative flex justify-center text-sm">
...
//             <button onClick={toggleAuth} className="text-[#008080] font-medium ml-1 hover:underline">
...
//         <motion.h2 className="text-3xl font-bold mb-6 text-center" {...fadeIn} transition={{ delay: 0.2 }}>
//           Discover More
//         </motion.h2>
